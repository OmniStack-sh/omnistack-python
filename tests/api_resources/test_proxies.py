...
class TestProxies:
    ...
    def test_method_list(self, client: Omnistack) -> None:
        ...
        assert_matches_type(Proxy, proxy, path=["response"])
    ...
    def test_streaming_response_list(self, client: Omnistack) -> None:
        with client.proxies.with_streaming_response.list(
            workspace_id="workspace_id",
            omniproxy_id="omniproxy_id",
        ) as response:
    ...
    def test_path_params_list(self, client: Omnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.proxies.with_raw_response.list(
                workspace_id="",
                omniproxy_id="omniproxy_id",
            )
...
class TestAsyncProxies:
    ...
    async def test_streaming_response_list(self, async_client: AsyncOmnistack) -> None:
        async with async_client.proxies.with_streaming_response.list(
            workspace_id="workspace_id",
            omniproxy_id="omniproxy_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncOmnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.proxies.with_raw_response.list(
                workspace_id="",
                omniproxy_id="omniproxy_id",
            )
