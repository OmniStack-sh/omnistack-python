...
class TestPlayground:
    ...
    def test_method_retrieve(self, client: Omnistack) -> None:
        playground = client.projects.playground.retrieve(
    ...
    def test_raw_response_retrieve(self, client: Omnistack) -> None:
        response = client.projects.playground.with_raw_response.retrieve(
            project_id="project_id",
            workspace_id="workspace_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Omnistack) -> None:
        with client.projects.playground.with_streaming_response.retrieve(
            project_id="project_id",
            workspace_id="workspace_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Omnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            client.projects.playground.with_raw_response.retrieve(
                project_id="project_id",
                workspace_id="",
            )
...
class TestAsyncPlayground:
    ...
    async def test_method_retrieve(self, async_client: AsyncOmnistack) -> None:
        playground = await async_client.projects.playground.retrieve(
            project_id="project_id",
            workspace_id="workspace_id",
        )
        assert_matches_type(object, playground, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncOmnistack) -> None:
        response = await async_client.projects.playground.with_raw_response.retrieve(
            project_id="project_id",
            workspace_id="workspace_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncOmnistack) -> None:
        async with async_client.projects.playground.with_streaming_response.retrieve(
            project_id="project_id",
            workspace_id="workspace_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncOmnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `workspace_id` but received ''"):
            await async_client.projects.playground.with_raw_response.retrieve(
                project_id="project_id",
                workspace_id="",
            )
