...
class UsersResource(SyncAPIResource):
    ...
    def login(
        self,
        *,
        about_user: Optional[str] | NotGiven = NOT_GIVEN,
        how_did_you_hear_about_us: Optional[str] | NotGiven = NOT_GIVEN,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        """
        This endpoint handles user registration, login, and updating user analytics.

            Functionality:
            - If the user already exists, it updates their analytics information based on the provided input.
            - If the user does not exist, it creates a new user and an associated workspace.,
